...
export default {
  ...
  methods: {
    addExercise() {
      this.$emit('add-exercise', this.newExercise, this.date);
      //clear form
      this.newExercise = {
        id:'', title: '', date: '',
        sets: 0, reps: [], weight: []
                ...
                <td>
                  <div class="col">
                    ...
                    <div v-for="(sets, i) in newExercise.sets" class="row g-3 q-pa-sm">
                      <div class="col-sm-4">
                        <q-input rounded outlined type="Number" v-model="newExercise.reps[i]"
                                 label="Reps"></q-input>
                      </div>
                      <div class="col-sm-4">
                        <q-input rounded outlined type="Number" v-model="newExercise.weight[i]"
                                 label="Weight"></q-input>
                      </div>
                    </div>
